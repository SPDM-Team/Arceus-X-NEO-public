...
-- Beta testing
local whitelist = {"4cd6f60cb195d6d9", "af15143601cdd261","f7102dcfb20dae30","9b9e2c926606eeb9","73c1100e8694ce04","5ade587278748002","02b4b02b35dd9cc4"}
...
if gethwid and table.find(whitelist, gethwid()) then
	...
	if not succ or not oldUI then -- New UI
		return executecode(game:HttpGet("https://gist.githubusercontent.com/Riky47/2f0cee3c4dfa5021022b041585476696/raw/704d9f2b3d168f2ea51ea4c5d7a5f699948166ba/Codex-Keysystem-2"))
	end
end
...
--if not succ or not oldUI then -- New UI
	...
	return executecode(game:HttpGet("https://gist.githubusercontent.com/Riky47/2f0cee3c4dfa5021022b041585476696/raw/704d9f2b3d168f2ea51ea4c5d7a5f699948166ba/Codex-Keysystem-2"))
	--return executecode(game:HttpGet("https://gist.githubusercontent.com/Riky47/24098f62ce8ace77a5be95f46d41a8c2/raw/e44996f824a6493659fb7ad922fe38da02ca7012/Codex-Beta-2"))
--end
