...
if gethwid and table.find(whitelist, gethwid()) then
	...
	if not succ or not oldUI then -- New UI
		return executecode(game:HttpGet("https://gist.githubusercontent.com/Riky47/24098f62ce8ace77a5be95f46d41a8c2/raw/634623756c0ae5d0c268d1492d0642da37f3d058/Codex-Beta-2"))
	end
end
